...
func TestLimitUntil(t *testing.T) {
	...
	t.Run("LimitUntil", func(t *testing.T) {
		testCase1[int]{
			Seq: func() iter.Seq[int] {
				return hiter.LimitUntil(func(e int) bool { return e < 6 }, slices.Values(src))
			},
	...
	t.Run("LimitUntil2", func(t *testing.T) {
		testCase2[int, int]{
			Seq: func() iter.Seq2[int, int] {
				return hiter.LimitUntil2(func(i, e int) bool { return e < 6 }, slices.All(src))
			},
	...
	t.Run("LimitUntil2", func(t *testing.T) {
		testCase2[int, int]{
			Seq: func() iter.Seq2[int, int] {
				return hiter.LimitUntil2(func(i, e int) bool { return i < 3 }, slices.All(src))
			},
