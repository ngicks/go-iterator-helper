...
func TestAlternate(t *testing.T) {
	...
	t.Run("Alternate2", func(t *testing.T) {
		...
		t.Run("only 1", func(t *testing.T) {
			testCase2[int, int]{
				Seq: func() iter.Seq2[int, int] {
					return ih.Alternate2(
						slices.All([]int{1, 2, 3}),
					)
				},
				Expected: []ih.KeyValue[int, int]{{0, 1}, {1, 2}, {2, 3}},
				BreakAt:  2,
			}.Test(t)
		})
		...
		t.Run("2", func(t *testing.T) {
			testCase2[int, int]{
				...
				Expected: []ih.KeyValue[int, int]{{0, 1}, {0, 4}, {1, 2}, {1, 5}, {2, 3}, {2, 6}},
				BreakAt:  2,
			}.Test(t)
		})
		...
		t.Run("first shorter", func(t *testing.T) {
			testCase2[int, int]{
				...
				Expected: []ih.KeyValue[int, int]{{0, 1}, {0, 4}},
				BreakAt:  2,
			}.Test(t)
		})
