	...
	t.Run("Skip", func(t *testing.T) {
		testCase1[int]{
			Seq: func() iter.Seq[int] {
				return ih.Skip(slices.Values(src), 5)
			},
	...
	t.Run("Skip2", func(t *testing.T) {
		testCase2[int, int]{
			Seq: func() iter.Seq2[int, int] {
				return ih.Skip2(slices.All(src), 5)
			},
...
func TestSkipUntil(t *testing.T) {
	...
	t.Run("SkipWhile", func(t *testing.T) {
		testCase1[int]{
			Seq: func() iter.Seq[int] {
				return ih.SkipWhile(slices.Values(src), func(e int) bool { return e == 6 })
			},
	...
	t.Run("SkipWhile2", func(t *testing.T) {
		testCase2[int, int]{
			Seq: func() iter.Seq2[int, int] {
				return ih.SkipWhile2(slices.All(src), func(i, e int) bool { return e == 6 })
			},
			Expected: []ih.KeyValue[int, int]{
				{10, 6}, {11, 2}, {12, 1},
				{13, 1}, {14, 9}, {15, 2},
